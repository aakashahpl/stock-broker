...
const fetchInterval = setInterval(async () => {
    ...
    try {
        ...
        fs.writeFileSync("/home/caesarisdead/Desktop/stock-broker/backend/news.json", JSON.stringify(response.data.feed));
    }
    catch (error) {
...
route.get("/", async (req, res) => {
    try {
        const fileData = fs.readFileSync("/home/caesarisdead/Desktop/stock-broker/backend/news.json", "utf8");
